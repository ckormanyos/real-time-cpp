...
//
  ...
  public:
    ...
    virtual bool send(const std::uint8_t byte_to_send)
    {
      ...
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x80)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x40)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x20)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x10)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x08)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x04)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x02)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
      ((std::uint_fast8_t(byte_to_send & UINT8_C(0x01)) != UINT8_C(0)) ? port_pin_mosi_type::set_pin_high() : port_pin_mosi_type::set_pin_low()); port_pin_sck__type::set_pin_high(); port_pin_sck__type::set_pin_low();
