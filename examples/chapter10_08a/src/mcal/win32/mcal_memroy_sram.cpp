...
namespace
{
  constexpr mcal_sram_uintptr_t mcal_sram_physical_pool_size_value = UINT32_C(0x02000000);

  uint8_t mcal_memory_sram_physical_pool_object[mcal_sram_physical_pool_size_value];
