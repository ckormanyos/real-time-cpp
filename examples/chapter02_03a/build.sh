...
# cd /usr/local/real-time-cpp/examples/chapter02_03a
# ./build.sh /usr/local/real-time-cpp/examples/chapter02_03a/tools/Util/MinGW/msys/1.0/local/gcc-9.2.0-avr/bin avr

# Usage example B (from Win* shell such as in Git for Win*)
# cd C:/Users/User/Documents/Ks/uC_Software/Boards/real-time-cpp/examples/chapter02_03a
# ./build.sh C:/Users/User/Documents/Ks/uC_Software/Boards/real-time-cpp/examples/chapter02_03a/tools/Util/MinGW/msys/1.0/local/gcc-9.2.0-avr/bin avr
