...
//
...
#ifndef CRC_BASE_2017_12_16_H_
  #define CRC_BASE_2017_12_16_H_
  ...
  public:
    ...
    crc_base& operator=(const crc_base& other_crc);
  ...
  protected:
    ...
    crc_base(const crc_base&) = default;
