...
//
  ...
  {
  public:
    cpp_crc08() { my_context.Crc_Value = 0U; }

    cpp_crc08(const cpp_crc08& other_crc) : cpp_crc_base(other_crc),
                                            my_context()
    {
      my_context.Crc_Value = other_crc.my_context.Crc_Value;
    }
  ...
  private:
    ...
    virtual       void*  storage()       { return reinterpret_cast<      void*>(&my_context.Crc_Value); }
    virtual const void*  storage() const { return reinterpret_cast<const void*>(&my_context.Crc_Value); }
    virtual const void* cstorage() const { return reinterpret_cast<const void*>(&my_context.Crc_Value); }
  ...
  {
  public:
    cpp_crc16() { my_context.Crc_Value = 0U; }
  ...
  {
  public:
    cpp_crc32() { my_context.Crc_Value = 0U; }
  ...
  {
  public:
    cpp_crc64() { my_context.Crc_Value = 0U; }
