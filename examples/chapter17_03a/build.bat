...
@rem Usage example A,
@rem cd "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter17_03a"
@rem build.bat "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter17_03a\tools\Util\msys64\usr\local\gcc-11.2.0-avr\bin" avr
...
@echo.Clean  bin directory : bin\*.o bin\chapter17_03a*.*
@if exist bin\*.o del /Q bin\*.o
@if exist bin\chapter17_03a*.* del /Q bin\chapter17_03a*.*
@echo.
...
@echo.Link     : objects to bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-g++ -x none -mrelax -nostartfiles %CFLAGS% %CPPFLAGS% %CINCLUDES% -Wl,--gc-sections -Wl,-Ttarget/micros/avr/make/avr.ld,-Map,bin/chapter17_03a.map bin/app_crc.o bin/app_led.o bin/cpp_crc_base.o bin/Crc08.o bin/Crc16.o bin/Crc32.o bin/Crc64.o bin/mcal.o bin/mcal_gcc_cxx_completion.o bin/mcal_cpu.o bin/mcal_gpt.o bin/mcal_irq.o bin/mcal_led.o bin/mcal_osc.o bin/mcal_port.o bin/mcal_wdg.o bin/os.o bin/os_task_control_block.o bin/sys_idle.o bin/sys_mon.o bin/sys_start.o bin/crt0.o bin/crt0_init_ram.o bin/crt1.o bin/int_vect.o -o bin/chapter17_03a.elf

@echo.
@echo.Extract  : executable hex file : from bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-objcopy -O ihex bin/chapter17_03a.elf bin/chapter17_03a.hex

@echo.Extract  : assembly list file  : from bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-objdump --disassemble bin/chapter17_03a.elf > bin/chapter17_03a.lss

@echo.Extract  : size information    : from bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-size -A -t bin/chapter17_03a.elf > bin\chapter17_03a_size.txt

@echo.Extract  : name information    : from bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-nm --numeric-sort --print-size bin/chapter17_03a.elf > bin\chapter17_03a_nm.txt

@echo.Extract  : demangled names     : from bin/chapter17_03a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-nm --numeric-sort --print-size bin/chapter17_03a.elf | %TOOL_PATH%\%TOOL_PREFIX%-c++filt > bin\chapter17_03a_cppfilt.txt

dir .\bin\chapter17_03a.elf .\bin\chapter17_03a.hex

if not exist .\bin\chapter17_03a.elf exit 1
if not exist .\bin\chapter17_03a.hex exit 1
