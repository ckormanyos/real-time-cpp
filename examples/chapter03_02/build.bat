...
@rem Usage example A,
@rem cd "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter03_02"
@rem build.bat "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter03_02\tools\Util\msys64\usr\local\gcc-11.2.0-avr\bin" avr
...
@echo.Clean  bin directory : bin\*.o bin\chapter03_02*.*
@if exist bin\*.o del /Q bin\*.o
@if exist bin\chapter03_02*.* del /Q bin\chapter03_02*.*
@echo.
...
@%TOOL_PATH%\%TOOL_PREFIX%-objdump --disassemble bin/chapter03_02.elf > bin/chapter03_02.lss
...
if not exist .\bin\chapter03_02.elf exit 1
if not exist .\bin\chapter03_02.hex exit 1
