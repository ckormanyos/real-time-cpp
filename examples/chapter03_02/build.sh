...
# ./build.sh /usr/local/real-time-cpp/examples/chapter03_02/tools/Util/MinGW/msys/1.0/local/gcc-7.2.0-avr/bin avr
...
# ./build.sh C:/Users/User/Documents/Ks/uC_Software/Boards/real-time-cpp/examples/chapter03_02/tools/Util/MinGW/msys/1.0/local/gcc-7.2.0-avr/bin avr
