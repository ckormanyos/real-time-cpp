...
# cd /usr/local/real-time-cpp/examples/chapter10_08
# ./build.sh /usr/local/real-time-cpp/examples/chapter10_08/tools/Util/MinGW/msys/1.0/local/gcc-9.2.0-avr/bin avr

# Usage example B (from Win* shell such as in Git for Win*)
# cd C:/Users/User/Documents/Ks/uC_Software/Boards/real-time-cpp/examples/chapter10_08
# ./build.sh C:/Users/User/Documents/Ks/uC_Software/Boards/real-time-cpp/examples/chapter10_08/tools/Util/MinGW/msys/1.0/local/gcc-9.2.0-avr/bin avr
...
CINCLUDES="-Isrc -Isrc/mcal/avr -Isrc/util/STL"
