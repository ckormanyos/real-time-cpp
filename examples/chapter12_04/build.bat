...
@echo.Clean  bin directory : bin\*.o bin\chapter12_04*.*
@if exist bin\*.o del /Q bin\*.o
@if exist bin\chapter12_04*.* del /Q bin\chapter12_04*.*
@echo.
...
@echo.Extract  : name information    : from bin/chapter12_04.elf
@%TOOL_PATH%\%TOOL_PREFIX%-nm --numeric-sort --print-size bin/chapter12_04.elf > bin\chapter12_04_nm.txt
