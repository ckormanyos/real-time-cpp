...
void app::benchmark::task_func()
{
  ...
  {
    const std::float32_t v = FLOAT32_C(11.0) / FLOAT32_C(9.0);
  ...
  app_benchmark_timer_type::blocking_delay(app_benchmark_timer_type::microseconds(25U));
  ...
  {
    const std::float32_t v = FLOAT32_C( 1.0) / FLOAT32_C(11.0);
    const std::float32_t u = FLOAT32_C(14.0) / FLOAT32_C(19.0);
    const std::float32_t x = FLOAT32_C( 2.0) / FLOAT32_C( 7.0);
