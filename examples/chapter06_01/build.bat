...
@rem build.bat "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter06_01\tools\Util\MinGW\msys\1.0\local\gcc-9.2.0-avr\bin" avr
...
@set CFLAGS=-Wall -Wextra -pedantic -mmcu=atmega328p -fsigned-char -Os -fno-exceptions
...
@%TOOL_PATH%\%TOOL_PREFIX%-objdump -h -S bin/chapter06_01.elf > bin/chapter06_01.lss
