...
CINCLUDES="-Isrc/os/FreeRTOS/Source/include/cfg/GCC-ATMega323 -Isrc/os/FreeRTOS/Source/portable/GCC-ATMega323 -Isrc/os/FreeRTOS/Source/include -Isrc/util/STL -Isrc/mcal/avr -Isrc "
