...
@rem build.bat "C:\Users\User\Documents\Ks\uC_Software\Boards\real-time-cpp\examples\chapter04_04a\tools\Util\msys64\usr\local\gcc-11.2.0-avr\bin" avr
...
@echo.Clean  bin directory : bin\*.o bin\chapter04_04a*.*
@if exist bin\*.o del /Q bin\*.o
@if exist bin\chapter04_04a*.* del /Q bin\chapter04_04a*.*
@echo.
...
@echo.Link     : objects to bin/chapter04_04a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-g++ -x none -mrelax -nostartfiles %CFLAGS% %CPPFLAGS% %CINCLUDES% -Wl,--gc-sections -Wl,-Ttarget/micros/avr/make/avr.ld,-Map,bin/chapter04_04a.map bin/app_benchmark.o bin/app_led.o bin/mcal.o bin/mcal_gcc_cxx_completion.o bin/mcal_cpu.o bin/mcal_eep.o bin/mcal_gpt.o bin/mcal_irq.o bin/mcal_led.o bin/mcal_osc.o bin/mcal_port.o bin/mcal_pwm.o bin/mcal_spi.o bin/mcal_wdg.o bin/os.o bin/os_task_control_block.o bin/sys_idle.o bin/sys_start.o bin/crt0.o bin/crt0_init_ram.o bin/crt1.o bin/int_vect.o -o bin/chapter04_04a.elf

@echo.
@echo.Extract  : executable hex file : from bin/chapter04_04a.elf
...
@echo.Extract  : name information    : from bin/chapter04_04a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-nm --numeric-sort --print-size bin/chapter04_04a.elf > bin\chapter04_04a_nm.txt

@echo.Extract  : demangled names     : from bin/chapter04_04a.elf
@%TOOL_PATH%\%TOOL_PREFIX%-nm --numeric-sort --print-size bin/chapter04_04a.elf | %TOOL_PATH%\%TOOL_PREFIX%-c++filt > bin\chapter04_04a_cppfilt.txt

dir .\bin\chapter04_04a.elf .\bin\chapter04_04a.hex

if not exist .\bin\chapter04_04a.elf exit 1
if not exist .\bin\chapter04_04a.hex exit 1
