...
void mcal::osc::init(const config_type*)
{
  ...
  mcal::reg::reg_access_static<std::uint32_t, std::uint32_t, mcal::reg::dcdc_reg3, static_cast<std::uint32_t>(UINT32_C(0x1F))>::template reg_msk<static_cast<std::uint32_t>(UINT32_C(0x1F))>();
  ...
  mcal::reg::reg_access_static<std::uint32_t, std::uint32_t, mcal::reg::ccm_analog_pll_arm, static_cast<std::uint32_t>(1UL << 16U)>::template reg_msk<static_cast<std::uint32_t>(3UL << 14U)>();

  // Set PLL1 to 600 MHz.
  //CCM_ANALOG_PLL_ARM = (CCM_ANALOG_PLL_ARM & (~((0x7FUL << 0U) | (1UL << 12U)))) | (1UL << 13U) | 0x64U;
  mcal::reg::reg_access_static<std::uint32_t, std::uint32_t, mcal::reg::ccm_analog_pll_arm, static_cast<std::uint32_t>(static_cast<std::uint32_t>(1UL << 13U) | static_cast<std::uint32_t>(UINT32_C(0x64)))>::template reg_msk<static_cast<std::uint32_t>(static_cast<std::uint32_t>(UINT32_C(0x7F)) | static_cast<std::uint32_t>(1UL << 12U))>();
  ...
  mcal::reg::reg_access_static<std::uint32_t, std::uint32_t, mcal::reg::ccm_cbcmr, static_cast<std::uint32_t>(3UL << 18U)>::template reg_msk<static_cast<std::uint32_t>(3UL << 18U)>();
}
