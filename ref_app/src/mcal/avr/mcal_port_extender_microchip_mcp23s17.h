...
//
...
#ifndef MCAL_PORT_EXTENDER_MICROCHIP_MCP23S17_2020_04_21_H_
  #define MCAL_PORT_EXTENDER_MICROCHIP_MCP23S17_2020_04_21_H_
  ...
  namespace mcal { namespace port { namespace extender {

  class mcal_port_extender_microchip_mcp23s17 : private util::noncopyable
  {
  private:
  ...
  public:
    mcal_port_extender_microchip_mcp23s17(util::communication_base& com,
    ...
    ~mcal_port_extender_microchip_mcp23s17() = default;
  ...
  private:
    ...
    mcal_port_extender_microchip_mcp23s17() = delete;
  };

  } } } // namespace mcal::port::extender

#endif // MCAL_PORT_EXTENDER_MICROCHIP_MCP23S17_2020_04_21_H_
