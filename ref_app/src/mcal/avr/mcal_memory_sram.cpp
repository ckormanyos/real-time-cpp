...
namespace
{
  ...
  using mcal_memory_sram_parallel_port_word_expander_addr_04_to_19_type = mcal::port::port_word_expander<std::uint16_t>;
  ...
  using mcal_memory_sram_parallel_port_pin_ce1_not_type    = mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portc, 4U>;
  using mcal_memory_sram_parallel_port_pin_ce2_____type    = mcal::port::port_pin_dummy; // Pullup over 2.2k to +5V
  using mcal_memory_sram_parallel_port_pin_oe__not_type    = mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portc, 5U>;
  using mcal_memory_sram_parallel_port_pin_we__not_type    = mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portb, 4U>;

  using mcal_memory_sram_parallel_port_word_data_08_type   = mcal::port::port_word<std::uint8_t,
                                                                                   std::uint8_t,
                                                                                   mcal::reg::portd>;

  using mcal_memory_sram_parallel_type =
    mcal::memory::sram::memory_sram_parallel_cypress_cy62158e<mcal_memory_sram_parallel_port_word_expander_addr_04_to_19_type,
                                                              ...
                                                              mcal_memory_sram_parallel_port_pin_ce1_not_type,
                                                              mcal_memory_sram_parallel_port_pin_ce2_____type,
                                                              mcal_memory_sram_parallel_port_pin_oe__not_type,
                                                              mcal_memory_sram_parallel_port_pin_we__not_type,
  ...
  #if 0
  using mcal_memory_sram_parallel_type =
    mcal::memory::sram::memory_sram_parallel_cypress_cy62167gn<mcal::port::port_pin_dummy,
                                                               mcal_memory_sram_parallel_port_word_expander_addr_04_to_19_type,
                                                               mcal_memory_sram_parallel_port_pin_addr03_type,
                                                               mcal_memory_sram_parallel_port_pin_addr02_type,
                                                               mcal_memory_sram_parallel_port_pin_addr01_type,
                                                               mcal_memory_sram_parallel_port_pin_addr00_type,
