...
extern "C" void __vector_timer4(void) __attribute__((used, noinline));
...
void mcal::gpt::init(const config_type*)
{
  if(gpt_is_initialized() == false)
  {
    ...
    mcal::reg::reg_access_static<std::uint32_t, std::uint16_t, mcal::reg::tim4_psc, UINT16_C(24 - 1)>::reg_set();
