...
void mcal::osc::init(const config_type*)
{
  ...
  const std::uint32_t
    status_freq_range
    {
        mcal::reg::reg_access_static<std::uint32_t, std::uint32_t, mcal::reg::hw_per_xosc_status>::reg_get()
      & std::uint32_t { UINT32_C(3) }
    };

  mcal::reg::reg_access_dynamic<std::uint32_t, std::uint32_t>::reg_msk
  (
    mcal::reg::hw_per_xosc_control,
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               std::uint32_t,
                               mcal::reg::hw_per_clocks_clk_ref_ctrl,
  ...
  (
    mcal::reg::reg_access_static<std::uint32_t,
                                 std::uint32_t,
                                 mcal::reg::hw_per_clocks_clk_ref_selected>::reg_get() != std::uint32_t { UINT32_C(1) << 2U }
  )
  {
    mcal::cpu::nop();
  }
    ...
    while(ref_div_int != UINT8_C(1))
    {
      ref_div_int =
        ...
        (
          mcal::reg::reg_access_static<std::uint32_t,
                                       std::uint32_t,
                                       mcal::reg::hw_per_clocks_clk_ref_div>::reg_get() >> 16U
        );
    }
  }
  ...
  while(!mcal::reg::reg_access_static<std::uint32_t,
                                      std::uint32_t,
                                      mcal::reg::hw_per_resets_reset_done,
    ...
    while(clk_sys_sel != UINT8_C(2))
    {
      clk_sys_sel =
        ...
        (
          mcal::reg::reg_access_static<std::uint32_t,
                                       std::uint32_t,
                                       mcal::reg::hw_per_clocks_clk_sys_selected>::reg_get() & std::uint32_t { UINT32_C(3) }
        );
    }
  }
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               std::uint32_t,
                               mcal::reg::hw_per_clocks_clk_peri_ctrl,
