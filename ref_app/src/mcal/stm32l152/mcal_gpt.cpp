...
extern "C" void __vector_timer4(void) __attribute__((interrupt));
...
extern "C" void __vector_timer4(void)
{
  ...
  mcal_gpt_system_tick = std::uint64_t(mcal_gpt_system_tick + UINT32_C(0x10000));
}
...
void mcal::gpt::init(const config_type*)
{
  if(gpt_is_initialized() == false)
  {
    ...
    mcal::reg::reg_access_static<std::uint32_t, std::uint16_t, mcal::reg::tim4_psc, UINT16_C(32 - 1)>::reg_set();
