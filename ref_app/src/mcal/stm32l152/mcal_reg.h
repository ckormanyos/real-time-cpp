...
//
...
#ifndef MCAL_REG_2018_01_06_H_
  #define MCAL_REG_2018_01_06_H_
  ...
  namespace mcal
  {
    namespace reg
    {
      ...
      constexpr std::uint32_t gpioh_base      = ahbperiph_base  + UINT32_C(0x1400);
      constexpr std::uint32_t gpiof_base      = ahbperiph_base  + UINT32_C(0x1800);
      constexpr std::uint32_t gpiog_base      = ahbperiph_base  + UINT32_C(0x1C00);
      ...
      constexpr std::uint32_t gpioa_otyper    = gpioa_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioa_idr       = gpioa_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpioa_odr       = gpioa_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioa_brr       = gpioa_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpiob_moder     = gpiob_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpiob_otyper    = gpiob_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiob_idr       = gpiob_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpiob_odr       = gpiob_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiob_brr       = gpiob_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpioc_moder     = gpioc_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpioc_otyper    = gpioc_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioc_idr       = gpioc_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpioc_odr       = gpioc_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioc_brr       = gpioc_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpiod_moder     = gpiod_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpiod_otyper    = gpiod_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiod_idr       = gpiod_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpiod_odr       = gpiod_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiod_brr       = gpiod_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpioe_moder     = gpioe_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpioe_otyper    = gpioe_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioe_idr       = gpioe_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpioe_odr       = gpioe_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpioe_brr       = gpioe_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpiof_moder     = gpiof_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpiof_otyper    = gpiof_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiof_idr       = gpiof_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpiof_odr       = gpiof_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiof_brr       = gpiof_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpiog_moder     = gpiog_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpiog_otyper    = gpiog_base      + UINT32_C(0x0004);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiog_idr       = gpiog_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpiog_odr       = gpiog_base      + UINT32_C(0x0014);  // 16-bit register.
      ...
      constexpr std::uint32_t gpiog_brr       = gpiog_base      + UINT32_C(0x0028);  // 16-bit register.

      constexpr std::uint32_t gpioh_moder     = gpioh_base      + UINT32_C(0x0000);  // 32-bit register.
      constexpr std::uint32_t gpioh_otyper    = gpioh_base      + UINT32_C(0x0004);  // 16-bit register.
      constexpr std::uint32_t gpioh_ospeedr   = gpioh_base      + UINT32_C(0x0008);  // 32-bit register.
      constexpr std::uint32_t gpioh_pupdr     = gpioh_base      + UINT32_C(0x000C);  // 32-bit register.
      constexpr std::uint32_t gpioh_idr       = gpioh_base      + UINT32_C(0x0010);  // 16-bit register.
      constexpr std::uint32_t gpioh_odr       = gpioh_base      + UINT32_C(0x0014);  // 16-bit register.
      constexpr std::uint32_t gpioh_bsrr      = gpioh_base      + UINT32_C(0x0018);  // 32-bit register.
      constexpr std::uint32_t gpioh_lckr      = gpioh_base      + UINT32_C(0x001C);  // 32-bit register.
      constexpr std::uint32_t gpioh_afrl      = gpioh_base      + UINT32_C(0x0020);  // 32-bit register.
      constexpr std::uint32_t gpioh_afrh      = gpioh_base      + UINT32_C(0x0024);  // 32-bit register.
      constexpr std::uint32_t gpioh_brr       = gpioh_base      + UINT32_C(0x0028);  // 16-bit register.
      ...
      constexpr std::uint32_t rcc_ahbenr      = rcc_base        + UINT32_C(0x001C);  // 32-bit register.
      constexpr std::uint32_t rcc_ahb2enr     = rcc_base        + UINT32_C(0x0020);  // 32-bit register.
      constexpr std::uint32_t rcc_apb1enr     = rcc_base        + UINT32_C(0x0024);  // 32-bit register.
      constexpr std::uint32_t rcc_ahblpenr    = rcc_base        + UINT32_C(0x0028);  // 32-bit register.
      constexpr std::uint32_t rcc_apb2lpenr   = rcc_base        + UINT32_C(0x002C);  // 32-bit register.
      constexpr std::uint32_t rcc_apb1lpenr   = rcc_base        + UINT32_C(0x0030);  // 32-bit register.
