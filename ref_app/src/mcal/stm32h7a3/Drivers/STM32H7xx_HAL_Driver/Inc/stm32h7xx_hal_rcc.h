...
static inline auto hal_rcc_hsi_config(const std::uint32_t state)
{
  modify_reg(
             RCC->CR,
...
static inline auto hal_rcc_hsi_calibration_value_adjust(const std::uint32_t HSICalibrationValue)
{
