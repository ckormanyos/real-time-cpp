...
//
...
#ifndef MCAL_LED_2019_02_24_H_
  #define MCAL_LED_2019_02_24_H_
  ...
  namespace mcal
  {
    namespace led
    {
      ...
      // The user LED on the esp xtensa32 board:
      // - TBD: Find or make a user LED.
