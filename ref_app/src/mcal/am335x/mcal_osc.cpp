...
{
  Bfx_PutBitsMask((std::uint32_t*) &CM_PER->L3_CLKSTCTRL,
                  CLKTRCTRL_SW_WKUP,
                  CLKTRCTRL_MASK);
  while((CM_PER->L3_CLKSTCTRL & CLKTRCTRL_MASK) != CLKTRCTRL_SW_WKUP) { ; }

  Bfx_PutBitsMask((std::uint32_t*) &CM_PER->L4LS_CLKSTCTRL,
                  CLKTRCTRL_SW_WKUP,
                  CLKTRCTRL_MASK);
  while((CM_PER->L4LS_CLKSTCTRL & CLKTRCTRL_MASK) != CLKTRCTRL_SW_WKUP) { ; }

  Bfx_PutBitsMask((std::uint32_t*) &CM_WKUP->CLKSTCTRL,
                  CLKTRCTRL_SW_WKUP,
                  CLKTRCTRL_MASK);
  ...
  Bfx_PutBitsMask((std::uint32_t*) &CM_PER->L3S_CLKSTCTRL,
                  CLKTRCTRL_SW_WKUP,
                  CLKTRCTRL_MASK);
...
void emif_init(void)
{
  ...
  Bfx_PutBitsMask((std::uint32_t*) &CM_PER->EMIF_CLKCTRL,
                  MODULEMODE_ENABLE,
                  MODULEMODE_MASK);
...
void gpio1_clock_config(void)
{
  ...
  Bfx_PutBitsMask((std::uint32_t*) &CM_PER->GPIO1_CLKCTRL,
                  MODULEMODE_ENABLE,
                  MODULEMODE_MASK);
...
void Mcu_DMTimer1ClkConfig(void)
{
  ...
  Bfx_PutBitsMask((std::uint32_t*) &CM_WKUP->TIMER1_CLKCTRL,
                  MODULEMODE_ENABLE,
                  MODULEMODE_MASK);
