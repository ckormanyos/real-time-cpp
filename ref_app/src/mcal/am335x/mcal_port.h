    ...
    namespace port
    {
      ...
      public:
        ...
        static void set_pin_high()
        {
          ...
          mcal::reg::access<addr_type, reg_type, pval, bpos>::bit_set();
        }

        static void set_pin_low()
        {
          // Set the port output value to low.
          mcal::reg::access<addr_type, reg_type, pval, bpos>::bit_clr();
        }
        ...
        static void toggle_pin()
        {
          ...
          mcal::reg::access<addr_type, reg_type, pval, bpos>::bit_not();
        }
