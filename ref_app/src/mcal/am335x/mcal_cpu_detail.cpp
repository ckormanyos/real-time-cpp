...
void mcal::cpu::detail::fill_the_tlb()
{
  ...
  // (Re)-Set the index of one single memory block to be of type
  // cache-able memory. This memory block contains all of
  // the code, the data, and the stack in the application.
