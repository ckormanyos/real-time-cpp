...
void mcal::osc::init(const config_type*)
{
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               ...
                               std::uint32_t { UINT32_C(20) }>::bit_set();
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               std::uint32_t,
                               mcal::reg::xosc_ctrl,
                               std::uint32_t { UINT32_C(2720) }>::template reg_msk<std::uint32_t { UINT32_C(0x0FFF) << 0U }>();
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               ...
                               std::uint32_t { UINT32_C(12) }>::bit_clr();

  // while(RESETS->RESET_DONE.bit.pll_sys != 1);
  while(!mcal::reg::reg_access_static<std::uint32_t,
                                      std::uint32_t,
                                      mcal::reg::resets_reset_done,
                                      std::uint32_t { UINT32_C(12) }>::bit_get()) { mcal::cpu::nop(); }
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               ...
                               std::uint32_t { UINT32_C(133) }>::template reg_msk<std::uint32_t { UINT32_C(0xFFF) << 0U }>();

  // PLL_SYS->PRIM.bit.POSTDIV1 = 6U;
  mcal::reg::reg_access_static<std::uint32_t,
                               std::uint32_t,
                               mcal::reg::pll_sys_prim,
                               std::uint32_t { UINT32_C(6) << 16U }>::template reg_msk<std::uint32_t { UINT32_C(0x7) << 16U }>();
  ...
  mcal::reg::reg_access_static<std::uint32_t,
                               ...
                               std::uint32_t { UINT32_C(1) << 8U }>::template reg_msk<std::uint32_t { UINT32_C(0x00FFFFFF) << 8U }>();

  // CLOCKS->CLK_SYS_DIV.bit.FRAC = 0U;
  mcal::reg::reg_access_static<std::uint32_t,
                               std::uint32_t,
                               mcal::reg::clocks_clk_sys_div,
                               std::uint32_t { UINT32_C(0) << 0U }>::template reg_msk<std::uint32_t { UINT32_C(0x000000FF) << 0U }>();
  ...
  while(!mcal::reg::reg_access_static<std::uint32_t,
                                      std::uint32_t,
                                      mcal::reg::resets_reset_done,
                                      std::uint32_t { UINT32_C(5) }>::bit_get()) { mcal::cpu::nop(); }
}
