  ...
  void util::safety::rom_memory_checksum<memory_address_type, memory_list_count>::finalize()
  {
    ...
    const std::uint32_t expected_result =
      util::make_long<std::uint16_t, std::uint32_t>(util::make_long<std::uint8_t, std::uint16_t>(expected_result_byte0, expected_result_byte1),
                                                    util::make_long<std::uint8_t, std::uint16_t>(expected_result_byte2, expected_result_byte3));
