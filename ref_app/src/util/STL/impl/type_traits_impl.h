...
//
  ...
  namespace xtraits
  {
    template<typename T> struct xis_integral                     : std::false_type { };
    template<>           struct xis_integral<bool>               : std::true_type  { };
    template<>           struct xis_integral<char>               : std::true_type  { };
    template<>           struct xis_integral<signed char>        : std::true_type  { };
    template<>           struct xis_integral<unsigned char>      : std::true_type  { };
    template<>           struct xis_integral<char16_t>           : std::true_type  { };
    template<>           struct xis_integral<char32_t>           : std::true_type  { };
    template<>           struct xis_integral<wchar_t>            : std::true_type  { };
    template<>           struct xis_integral<short>              : std::true_type  { };
    template<>           struct xis_integral<int>                : std::true_type  { };
    template<>           struct xis_integral<long>               : std::true_type  { };
    template<>           struct xis_integral<long long>          : std::true_type  { };
    template<>           struct xis_integral<unsigned short>     : std::true_type  { };
    template<>           struct xis_integral<unsigned int>       : std::true_type  { };
    template<>           struct xis_integral<unsigned long>      : std::true_type  { };
    template<>           struct xis_integral<unsigned long long> : std::true_type  { };

    template<typename T> struct xis_floating_point               : std::false_type { };
    template<>           struct xis_floating_point<float>        : std::true_type  { };
    template<>           struct xis_floating_point<double>       : std::true_type  { };
    template<>           struct xis_floating_point<long double>  : std::true_type  { };
  }
  ...
  namespace std
  {
    ...
    template<typename T>    struct is_integral       : xtraits::xis_integral      <typename remove_cv<T>::type> { };
    template<typename T>    struct is_floating_point : xtraits::xis_floating_point<typename remove_cv<T>::type> { };
    ...
    template<typename T,
             std::size_t N> struct is_array<T[N]>    : std::true_type  {};
  }
