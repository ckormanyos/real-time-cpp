...
//
  ...
  template<typename T>
  const inline T const_pi()
  {
    return T(3.1415926535897932384626433832795028841972L);
  }

  template<typename T>
  const inline T const_sqrt_pi()
  {
    return T(1.7724538509055160272981674833411451827975L);
  }

  template<typename T>
  const inline T const_ln2()
  {
    return T(0.6931471805599453094172321214581765680755L);
  }

  template<typename T>
  const inline T const_e()
  {
    return T(2.7182818284590452353602874713526624977572L);
  }

  template<typename T>
  const inline T const_euler_gamma()
  {
