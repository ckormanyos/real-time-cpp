...
namespace float_limits
{
  ...
  STL_LOCAL_CONSTEXPR float       rl78_nan_flt  = static_cast<float>(__builtin_nan(""));
  STL_LOCAL_CONSTEXPR float       rl78_inf_flt  = static_cast<float>(__builtin_inf());
  STL_LOCAL_CONSTEXPR double      rl78_nan_dbl  = __builtin_nan("");
  STL_LOCAL_CONSTEXPR double      rl78_inf_dbl  = __builtin_inf();
  STL_LOCAL_CONSTEXPR long double rl78_nan_ldbl = static_cast<long double>(__builtin_nan(""));
  STL_LOCAL_CONSTEXPR long double rl78_inf_ldbl = static_cast<long double>(__builtin_inf());
}
...
namespace std
{
  ...
  {
    return float_limits::rl78_nan_flt;
  }
  ...
  {
    return float_limits::rl78_inf_ldbl;
  }
}
