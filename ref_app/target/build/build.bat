@rem
@rem  Copyright Christopher Kormanyos 2007 - 2015.
...
@rem       bcm2835_raspi_b  : RaspberryPi Model B, creates a bare-metal binary file "kernel.img"
@rem       pic32mx795fx     : PIC32(R) MIPS
