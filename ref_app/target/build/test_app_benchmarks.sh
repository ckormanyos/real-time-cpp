...
$GCC -std=$STD -Wall         -O3 -march=native -fsanitize=address -I./src/mcal/host -I./src                    -DAPP_BENCHMARK_TYPE=APP_BENCHMARK_TYPE_WIDE_DECIMAL        -DAPP_BENCHMARK_STANDALONE_MAIN ./src/app/benchmark/app_benchmark_soft_double_h2f1.cpp     -o ./bin/app_benchmark_soft_double_h2f1.exe
