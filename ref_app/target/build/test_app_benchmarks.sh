...
$GCC -std=$STD -Wall -Werror -O3 -march=native -fsanitize=address -I./src/mcal/host -I./src -I../boost-root -DAPP_BENCHMARK_TYPE=APP_BENCHMARK_TYPE_BOOST_MATH_CBRT     -DAPP_BENCHMARK_STANDALONE_MAIN ./src/app/benchmark/app_benchmark_boost_math_cbrt.cpp      -o ./bin/app_benchmark_boost_math_cbrt.exe
