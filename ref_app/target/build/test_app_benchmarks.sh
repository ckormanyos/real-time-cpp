...
$GCC -std=$STD -Wall -Werror -O3 -march=native -fsanitize=address -I./src/mcal/host -I./src                                            -DAPP_BENCHMARK_TYPE=APP_BENCHMARK_TYPE_SOFT_DOUBLE_H2F1    -DAPP_BENCHMARK_STANDALONE_MAIN ./src/app/benchmark/app_benchmark_soft_double_h2f1.cpp     -o ./bin/app_benchmark_soft_double_h2f1.exe
...
$GCC -std=$STD -Wall         -O3 -march=native -fsanitize=address -I./src/mcal/host -I./src -I../../boost-root -DBOOST_MATH_STANDALONE -DAPP_BENCHMARK_TYPE=APP_BENCHMARK_TYPE_BOOST_MATH_CBRT     -DAPP_BENCHMARK_STANDALONE_MAIN ./src/app/benchmark/app_benchmark_boost_math_cbrt.cpp      -o ./bin/app_benchmark_boost_math_cbrt.exe
...
./bin/app_benchmark_boost_math_cbrt.exe
result_var_boost_math_cbrt=$?
...
echo "result_var_boost_math_cbrt   : "  "$result_var_boost_math_cbrt"

result_total=$((result_var_complex+result_var_crc+result_var_fast_math+result_var_filter+result_var_fixed_point+result_var_float+result_var_hash+result_var_none+result_var_pi_agm+result_var_pi_spigot+result_var_pi_spigot_single+$result_var_soft_double_h2f1+result_var_trapezoid_integral+result_var_wide_decimal+result_var_wide_integer+result_var_boost_math_cbrt))
