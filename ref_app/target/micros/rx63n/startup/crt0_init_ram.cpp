...
void crt::init_ram()
{
  ...
  const std::size_t size = std::size_t(  static_cast<const memory_aligned_type*>(static_cast<const void*>(&data_end))
  ...
  std::copy(static_cast<const memory_aligned_type*>(static_cast<const void*>(&rom_data_begin)),
            static_cast<const memory_aligned_type*>(static_cast<const void*>(&rom_data_begin)) + size,
