...
/*****************************************************************************/
/*
** Macros which can be passed as vBit to the API McASPDITEnable
*/
...
/*****************************************************************************/
/*
** Macros which can be passed as channel to the APIs McASPDITChanStatWrite
** and McASPDITChanStatRead, McASPDITChanUsrDataWrite and
** McASPDITChanUsrDataRead
*/
...
/*****************************************************************************/
/*
** Macros which can be passed as chStatBits to the APIs McASPDITChanStatWrite
** and McASPDITChanStatRead
*/
...
extern void McASPTxBufWrite(unsigned int baseAddr, unsigned int serNum,
                            unsigned int data);
extern void McASPDITEnable(unsigned int baseAddr, unsigned int vBit);
