...
#define RTC_IDLEMODE_FORCE_IDLE        (RTCSS_SYSCONFIG_REG_IDLEMODE_FORCE_IDLE_MODE)
#define RTC_IDLEMODE_NO_IDLE           (RTCSS_SYSCONFIG_REG_IDLEMODE_NO_IDLE_MODE)
#define RTC_IDLEMODE_SMART_IDLE        (RTCSS_SYSCONFIG_REG_IDLEMODE_SMART_IDLE_MODE)
#define RTC_IDLEMODE_SMART_IDLE_WAKEUP (RTCSS_SYSCONFIG_REG_IDLEMODE_SMART_IDLE_WAKEUP_CAPABLE_MODE_)

/*
** Values are used to enable/disable Wakeup generation on Alarm event.
*/

#define RTC_ALARM_WAKEUP_ENABLE        (RTC_IRQ_WAKEEN_0_ALARM_WAKEEN_WAKEUP_ENABLED <<  \
                                        RTC_IRQ_WAKEEN_0_ALARM_WAKEEN_SHIFT)
#define RTC_ALARM_WAKEUP_DISABLE       (RTC_IRQ_WAKEEN_0_ALARM_WAKEEN_WAKEUP_DISABLED << \
                                        RTC_IRQ_WAKEEN_0_ALARM_WAKEEN_SHIFT)
...
#define RTC_TIMER_WAKEUP_ENABLE        (RTC_IRQ_WAKEEN_0_TIMER_WAKEEN_WAKEUP_ENABLED << \
                                        RTC_IRQ_WAKEEN_0_TIMER_WAKEEN_SHIFT)
#define RTC_TIMER_WAKEUP_DISABLE       (RTC_IRQ_WAKEEN_0_TIMER_WAKEEN_WAKEUP_DISABLED << \
                                        RTC_IRQ_WAKEEN_0_TIMER_WAKEEN_SHIFT)
...
#define RTC_32KCLK_ENABLE              (1 << RTC_OSC_32KCLK_EN_SHIFT)
#define RTC_32KCLK_DISABLE             (0 << RTC_OSC_32KCLK_EN_SHIFT)
