...
#define UART_IER_EOF_IT   (0x00000080u)
#define UART_IER_EOF_IT_SHIFT   (0x00000007u)
#define UART_IER_EOF_IT_DISABLE   (0x0u)
#define UART_IER_EOF_IT_ENABLE   (0x1u)

#define UART_IER_LAST_RX_BYTE_IT   (0x00000004u)
#define UART_IER_LAST_RX_BYTE_IT_SHIFT   (0x00000002u)
#define UART_IER_LAST_RX_BYTE_IT_DISABLE   (0x0u)
#define UART_IER_LAST_RX_BYTE_IT_ENABLE   (0x1u)
...
#define UART_IER_RX_OVERRUN_IT   (0x00000008u)
#define UART_IER_RX_OVERRUN_IT_SHIFT   (0x00000003u)
#define UART_IER_RX_OVERRUN_IT_DISABLE   (0x0u)
#define UART_IER_RX_OVERRUN_IT_ENABLE   (0x1u)

#define UART_IER_RX_STOP_IT   (0x00000004u)
#define UART_IER_RX_STOP_IT_SHIFT   (0x00000002u)
#define UART_IER_RX_STOP_IT_DISABLE   (0x0u)
#define UART_IER_RX_STOP_IT_ENABLE   (0x1u)
...
#define UART_IER_STS_FIFO_TRIG_IT   (0x00000010u)
#define UART_IER_STS_FIFO_TRIG_IT_SHIFT   (0x00000004u)
#define UART_IER_STS_FIFO_TRIG_IT_DISABLE   (0x0u)
#define UART_IER_STS_FIFO_TRIG_IT_ENABLE   (0x0u)
...
#define UART_IER_TX_STATUS_IT   (0x00000020u)
#define UART_IER_TX_STATUS_IT_SHIFT   (0x00000005u)
#define UART_IER_TX_STATUS_IT_DISABLE   (0x0u)
#define UART_IER_TX_STATUS_IT_ENABLE   (0x1u)
...
#define UART_IIR_EOF_IT   (0x00000080u)
#define UART_IIR_EOF_IT_SHIFT   (0x00000007u)
#define UART_IIR_EOF_IT_ACTIVE   (0x1u)
#define UART_IIR_EOF_IT_INACTIVE   (0x0u)
...
#define UART_IIR_IT_PENDING_NO   (0x0u)
#define UART_IIR_IT_PENDING_YES   (0x1u)
...
#define UART_IIR_LINE_STS_IT   (0x00000040u)
#define UART_IIR_LINE_STS_IT_SHIFT   (0x00000006u)
#define UART_IIR_LINE_STS_IT_ACTIVE   (0x1u)
#define UART_IIR_LINE_STS_IT_INACTIVE   (0x0u)

#define UART_IIR_RHR_IT   (0x00000001u)
#define UART_IIR_RHR_IT_SHIFT   (0x00000000u)
#define UART_IIR_RHR_IT_ACTIVE   (0x1u)
#define UART_IIR_RHR_IT_INACTIVE   (0x0u)

#define UART_IIR_RX_FIFO_LAST_BYTE_IT   (0x00000004u)
#define UART_IIR_RX_FIFO_LAST_BYTE_IT_SHIFT   (0x00000002u)
#define UART_IIR_RX_FIFO_LAST_BYTE_IT_ACTIVE   (0x1u)
#define UART_IIR_RX_FIFO_LAST_BYTE_IT_INACTIVE   (0x0u)

#define UART_IIR_RX_OE_IT   (0x00000008u)
#define UART_IIR_RX_OE_IT_SHIFT   (0x00000003u)
#define UART_IIR_RX_OE_IT_ACTIVE   (0x1u)
#define UART_IIR_RX_OE_IT_INACTIVE   (0x0u)

#define UART_IIR_STS_FIFO_IT   (0x00000010u)
#define UART_IIR_STS_FIFO_IT_SHIFT   (0x00000004u)
#define UART_IIR_STS_FIFO_IT_ACTIVE   (0x1u)
#define UART_IIR_STS_FIFO_IT_INACTIVE   (0x0u)

#define UART_IIR_THR_IT   (0x00000002u)
#define UART_IIR_THR_IT_SHIFT   (0x00000001u)
#define UART_IIR_THR_IT_ACTIVE   (0x1u)
#define UART_IIR_THR_IT_INACTIVE   (0x0u)

#define UART_IIR_TX_STATUS_IT   (0x00000020u)
#define UART_IIR_TX_STATUS_IT_SHIFT   (0x00000005u)
#define UART_IIR_TX_STATUS_IT_ACTIVE   (0x1u)
#define UART_IIR_TX_STATUS_IT_INACTIVE   (0x0u)
...
#define UART_LSR_RX_STOP   (0x00000020u)
...
/* MVR */
#define UART_MVR_CUSTOM   (0x000000C0u)
#define UART_MVR_CUSTOM_SHIFT   (0x00000006u)

#define UART_MVR_FUNC   (0x0FFF0000u)
#define UART_MVR_FUNC_SHIFT   (0x00000010u)

#define UART_MVR_MAJOR   (0x00000700u)
#define UART_MVR_MAJOR_SHIFT   (0x00000008u)

#define UART_MVR_MINOR   (0x0000003Fu)
#define UART_MVR_MINOR_SHIFT   (0x00000000u)

#define UART_MVR_RTL   (0x0000F800u)
#define UART_MVR_RTL_SHIFT   (0x0000000Bu)

#define UART_MVR_SCHEME   (0xC0000000u)
#define UART_MVR_SCHEME_SHIFT   (0x0000001Eu)
...
#define UART_MDR3_SET_TX_DMA_THRESHOLD   (0x0000001Fu)
#define UART_MDR3_SET_TX_DMA_THRESHOLD_SHIFT   (0x00000000u)
#define UART_MDR3_SET_TX_DMA_THRESHOLD_64   (0x0u)
#define UART_MDR3_SET_TX_DMA_THRESHOLD_REG   (0x1u)


/* TX_DMA_THRESHOLD */
#define UART_TX_DMA_THRESHOLD_TX_DMA_THRESHOLD   (0x0000001Fu)
