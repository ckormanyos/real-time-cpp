...
[![Build Status](https://github.com/ckormanyos/real-time-cpp/workflows/real-time-cpp.yml/badge.svg?branch=develop)](https://github.com/ckormanyos/real-time-cpp/actions)
==================
...
|                  |  Master  |
|------------------|----------|
| Github Actions | [![Build Status](https://github.com/ckormanyos/real-time-cpp/workflows/real-time-cpp.yml/badge.svg?branch=develop)](https://github.com/ckormanyos/real-time-cpp/actions)
