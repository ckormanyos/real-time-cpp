...
namespace
{
  ...
  public:
    display_fnd567()
    {
      segment_a_port::set_pin_low();
      segment_b_port::set_pin_low();
      segment_c_port::set_pin_low();
      segment_d_port::set_pin_low();
      segment_e_port::set_pin_low();
      segment_f_port::set_pin_low();
      segment_g_port::set_pin_low();
      segment_dp_port::set_pin_low();
    ...
    virtual bool write(const std::uint8_t byte_to_write)
    {
      ...
      ((std::uint8_t(segment_pattern & UINT8_C(0x01)) != UINT8_C(0)) ? segment_a_port::set_pin_high() : segment_a_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x02)) != UINT8_C(0)) ? segment_b_port::set_pin_high() : segment_b_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x04)) != UINT8_C(0)) ? segment_c_port::set_pin_high() : segment_c_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x08)) != UINT8_C(0)) ? segment_d_port::set_pin_high() : segment_d_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x10)) != UINT8_C(0)) ? segment_e_port::set_pin_high() : segment_e_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x20)) != UINT8_C(0)) ? segment_f_port::set_pin_high() : segment_f_port::set_pin_low());
      ((std::uint8_t(segment_pattern & UINT8_C(0x40)) != UINT8_C(0)) ? segment_g_port::set_pin_high() : segment_g_port::set_pin_low());
    ...
    {
      (dp_on ? segment_dp_port::set_pin_high()
             : segment_dp_port::set_pin_low ());
...
mcal::display::display_seven_segment& mcal::display::display0()
{
  ...
  typedef mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portc, UINT8_C(4)> portc0_type;
  typedef mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portd, UINT8_C(4)> portd6_type;
  typedef mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portd, UINT8_C(4)> portd5_type;
  typedef mcal::port::port_pin<std::uint8_t, std::uint8_t, mcal::reg::portc, UINT8_C(4)> portc3_type;
